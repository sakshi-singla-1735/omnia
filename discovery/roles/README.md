...
Each role can be customized through:
- Variable overrides in inventory files
- Custom templates in role template directories
- Conditional execution based on software_config
- Role-specific vars/main.yml modifications
...
### General Debug Steps
1. Check variable values: `ansible-playbook -vvv`
2. Validate configuration files syntax
3. Verify network connectivity
4. Check file permissions and ownership
5. Review role-specific logs

### Common Issues
- **NFS mount failures**: Check exports and firewall
- **OpenCHAMI errors**: Verify ochami CLI and environment
- **Validation failures**: Review input file syntax
- **Permission denied**: Check SELinux contexts and ownership
...
1. Update the role's README.md with detailed documentation
2. Follow existing naming conventions and structure
3. Add appropriate error handling and validation
4. Update this overview README with new role information
...
Each active role has a dedicated README.md file in its directory containing:
...
Refer to individual role READMEs for comprehensive information.
...
- Review individual role README files
- Check Omnia documentation
- Review Ansible playbook logs
- Contact your Omnia administrator
